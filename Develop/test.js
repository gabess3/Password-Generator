...
var passwordLength = 0; //Arbitrary length - this will change based on user input.
...
function generatePassword() {
  ...
  // Prompts user to select and length of password. 
  ...
  // Alerts user to select atleast one of the password criteria.    
  ...
  // Prompts user to select various password criteria. 
    ...
    if (upper) {
      alert("This criteria has been added to your password.");
      upperConfirm = true;
    } else if (!upper){ 
